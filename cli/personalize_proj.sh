...
mkdir -p src/main/java/$NEW_PACKAGE_PATH
mkdir -p src/release/java/$NEW_PACKAGE_PATH
mkdir -p src/debug/java/$NEW_PACKAGE_PATH
mkdir -p src/androidTest/java/$NEW_PACKAGE_PATH

mv src/main/java/$ORIGINAL_PACKAGE_PATH/* src/main/java/$NEW_PACKAGE_PATH
mv src/debug/java/$ORIGINAL_PACKAGE_PATH/* src/debug/java/$NEW_PACKAGE_PATH
mv src/release/java/$ORIGINAL_PACKAGE_PATH/* src/release/java/$NEW_PACKAGE_PATH
...
rm -rf src/debug/java/$ORIGINAL_PACKAGE_PATH
rm -rf src/release/java/$ORIGINAL_PACKAGE_PATH
rm -rf src/androidTest/java/$ORIGINAL_PACKAGE_PATH
...
rmdir src/release/java/co/kaush/mystarterapp/myappmodule > /dev/null 2>&1
rmdir src/release/java/co/kaush/mystarterapp > /dev/null 2>&1
rmdir src/release/java/co/kaush > /dev/null 2>&1
rmdir src/release/java/co > /dev/null 2>&1

rmdir src/debug/java/co/kaush/mystarterapp/myappmodule > /dev/null 2>&1
rmdir src/debug/java/co/kaush/mystarterapp > /dev/null 2>&1
rmdir src/debug/java/co/kaush > /dev/null 2>&1
rmdir src/debug/java/co > /dev/null 2>&1
...
sed -i "" -e "s/$ORIGINAL_PACKAGE_NAME/$NEW_PACKAGE_NAME/g" ${NEW_APP_MAIN_MODULE}/src/release/AndroidManifest.xml
sed -i "" -e "s/$ORIGINAL_PACKAGE_NAME/$NEW_PACKAGE_NAME/g" ${NEW_APP_MAIN_MODULE}/src/debug/AndroidManifest.xml
sed -i "" -e "s/$ORIGINAL_PACKAGE_NAME/$NEW_PACKAGE_NAME/g" ${NEW_APP_MAIN_MODULE}/src/androidTest/AndroidManifest.xml
